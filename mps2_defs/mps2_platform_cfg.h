...
**       be truncated.
*/
#define CFE_PLATFORM_ES_ER_LOG_MAX_CONTEXT_SIZE     16
...
**       verified.
*/
#define CFE_PLATFORM_ES_RAM_DISK_SECTOR_SIZE      128
...
**       verified.
*/
#define CFE_PLATFORM_ES_RAM_DISK_NUM_SECTORS      128
...
**       off.
*/
#define CFE_PLATFORM_ES_RAM_DISK_PERCENT_RESERVED 0  /* @FIXME verify no need of ramdisk for startup here */
...
*/
#define CFE_PLATFORM_ES_CDS_SIZE                  ( 8 * 1024 )
...
**       on this configuration paramater.
*/
#define CFE_PLATFORM_ES_USER_RESERVED_SIZE         ( 2 * 1024 )
...
*/
#define CFE_PLATFORM_ES_RESET_AREA_SIZE  ( 150 * 1024 )
...
*/
#define CFE_PLATFORM_ES_PERF_CHILD_PRIORITY                4
...
**       Not Applicable
*/
#define CFE_PLATFORM_EVS_START_TASK_PRIORITY               2
...
**       Not Applicable
*/
#define CFE_PLATFORM_SB_START_TASK_PRIORITY                3
...
**       Not Applicable
*/
#define CFE_PLATFORM_ES_START_TASK_PRIORITY                3
...
*/
#define CFE_PLATFORM_TIME_START_TASK_PRIORITY              3
#define CFE_PLATFORM_TIME_TONE_TASK_PRIORITY               1
#define CFE_PLATFORM_TIME_1HZ_TASK_PRIORITY                1
...
**       Not Applicable
*/
#define CFE_PLATFORM_TBL_START_TASK_PRIORITY               4
